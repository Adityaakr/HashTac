...
// Default IDL path: src/assets/tic_tac_toe_sails_client.idl
...
async function main() {
  const idlPath = process.argv[2] || resolve(FRONTEND_DIR, "src/assets/tic_tac_toe_sails_client.idl");
  ...
  try {
    ...
    console.error(`Expected path: frontend/src/assets/tic_tac_toe_sails_client.idl`);
    process.exit(1);
  }
  ...
  const idlRelPath = "src/assets/tic_tac_toe_sails_client.idl";
